        ...
        <div class="authentication-inner">
                ...
                <div class="card-body">
                    ...
                    <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="Enter your email" autofocus value="{{ old('email') }}" required />
                        </div>
            ...
            <!-- /Register -->
             <div class="text-center" style="font-size: 22px;">
                <p class="text-muted"><b> Don’t have an account? <a href="{{ route('register') }}">Sign up</a></b></p>
            </div>
        </div>
    </div>
@endsection
