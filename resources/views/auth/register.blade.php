...
<head>
    ...
    <link rel="stylesheet" href="vendor/css/core.css?v=0.026" class="template-customizer-core-css" />
    <link rel="stylesheet" href="vendor/css/theme-default.css?v=0.1" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="{{ asset('css/demo.css?v=0.05') }}">
